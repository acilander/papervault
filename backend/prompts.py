...
- Korrigiere offensichtliche OCR-/Tippfehler im Absender, wenn die korrekte Schreibweise eindeutig ist (z.B. 'Bodan-Württemberg' → 'Baden-Württemberg', 'Telecon' → 'Telekom'). Verwende nur bekannte, sichere Korrekturen und erfinde keine neuen Namen."""
