...
from api.routes import documents, senders, stats, monitor, chat, collections, config as config_router, items, contracts, services, feedback, low_value_rules, tax, identifiers, transactions
