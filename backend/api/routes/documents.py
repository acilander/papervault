...
def update_document(doc_id: int, body: DocumentUpdate):
    ...
    classification_fields = {"sender", "date", "document_type", "category", "summary", "keywords"}
    if doc.get("status") == "classification_failed" and classification_fields & set(updates):
